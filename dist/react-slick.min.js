            ...
            function e(t) {
              ...
              return (
                ...
                me(
                  ...
                  "listRefHandler",
                  function(e) {
                    n.props.listRefHandler && n.props.listRefHandler(e),
                      (n.list = e);
                  }
                ),
                me(be(n), "trackRefHandler", function(e) {
                  return (n.track = e);
                }),
                me(be(n), "adaptHeight", function() {
                  if (n.props.adaptiveHeight && n.list) {
                    var e = n.list.querySelector(
                      '[data-index="'.concat(n.state.currentSlide, '"]')
                    );
                    n.list.style.height = v(e) + "px";
                  }
                }),
                me(be(n), "componentWillMount", function() {
                  if (
                    (n.ssrInit(),
                    n.props.onInit && n.props.onInit(),
                    n.props.lazyLoad)
                  ) {
                    var e = h(ye({}, n.props, {}, n.state));
                    0 < e.length &&
                ...
                me(be(n), "componentDidMount", function() {
                  var e = ye({ listRef: n.list, trackRef: n.track }, n.props);
                ...
                me(be(n), "componentWillUnmount", function() {
                ...
                me(be(n), "componentWillReceiveProps", function(e) {
                  for (
                    var t = ye(
                ...
                me(be(n), "componentDidUpdate", function() {
                  if (
                    (n.checkImagesLoad(),
                ...
                me(be(n), "onWindowResized", function(e) {
                ...
                me(be(n), "updateState", function(e, t, r) {
                  var o = (function(e) {
                    var t,
                      n = i.a.Children.count(e.children),
                      r = Math.ceil(y(s.a.findDOMNode(e.listRef))),
                      o = Math.ceil(y(s.a.findDOMNode(e.trackRef)));
                    if (e.vertical) t = r;
                    else {
                  ...
                  e = ye(
                    {},
                    (e = ye({}, e, {}, o, { slideIndex: o.currentSlide })),
                    { left: P(e) }
                  );
                  var a = L(e);
                  (!t &&
                ...
                me(be(n), "progressiveLazyLoad", function() {
                  for (
                    var e = [],
                      t = ye({}, n.props, {}, n.state),
                ...
                me(be(n), "slideHandler", function(e) {
                  var t =
                      1 < arguments.length &&
                      void 0 !== arguments[1] &&
                      arguments[1],
                          ...
                          y
                            ? (O = {
                                animating: !(S = {
                                  animating: !0,
                                  currentSlide: v,
                                  trackStyle: M(p({}, e, { left: b })),
                                  lazyLoadedList: a
                                }),
                                currentSlide: v,
                                trackStyle: L(p({}, e, { left: m })),
                                swipeLeft: null
                              })
                            : (S = {
                                currentSlide: v,
                ...
                me(be(n), "changeSlide", function(e) {
                  var t =
                      1 < arguments.length &&
                      void 0 !== arguments[1] &&
                      arguments[1],
                    r = (function(e, t) {
                      ...
                      if (
                        ...
                        return null;
                      return o;
                    })(ye({}, n.props, {}, n.state), e);
                  (0 !== r && !r) ||
                    (!0 === t ? n.slideHandler(r, t) : n.slideHandler(r));
                }),
                me(be(n), "clickHandler", function(e) {
                  !1 === n.clickable &&
                    (e.stopPropagation(), e.preventDefault()),
                    (n.clickable = !0);
                }),
                me(be(n), "keyHandler", function(e) {
                ...
                me(be(n), "selectHandler", function(e) {
                  n.changeSlide(e);
                }),
                me(be(n), "disableBodyScroll", function() {
                ...
                me(be(n), "enableBodyScroll", function() {
                  window.ontouchmove = null;
                }),
                me(be(n), "swipeStart", function(e) {
                ...
                me(be(n), "swipeMove", function(e) {
                  var t = (function(e, t) {
                    ...
                    if (!n) {
                      ...
                      s && (w.swipeLength = x);
                      var j = (a ? -1 : 1) * (w.curX > w.startX ? 1 : -1);
                ...
                me(be(n), "play", function() {
                  var e;
                  if (n.props.rtl)
                    e = n.state.currentSlide - n.props.slidesToScroll;
                  else {
                    if (!g(ye({}, n.props, {}, n.state))) return !1;
                    e = n.state.currentSlide + n.props.slidesToScroll;
                  }
                  n.slideHandler(e);
                }),
                me(be(n), "autoPlay", function(e) {
                  n.autoplayTimer && clearInterval(n.autoplayTimer);
                ...
                me(be(n), "onDotsOver", function() {
                  return n.props.autoplay && n.pause("hovered");
                }),
                me(be(n), "onDotsLeave", function() {
                  return (
                    n.props.autoplay &&
                ...
                me(be(n), "onTrackOver", function() {
                  return n.props.autoplay && n.pause("hovered");
                }),
                me(be(n), "onTrackLeave", function() {
                  return (
                    n.props.autoplay &&
                    "hovered" === n.state.autoplaying &&
                    n.autoPlay("leave")
                ...
                me(be(n), "onSlideFocus", function() {
                  return n.props.autoplay && n.pause("focused");
                }),
                me(be(n), "onSlideBlur", function() {
                  return (
                    n.props.autoplay &&
              ...
              return (
                ...
                Pe(
                  Le(
                    (n = (function(e, t) {
                      return !t ||
                        ("object" !== Te(t) && "function" != typeof t)
                        ? Le(e)
                        : t;
                    })(this, je(e).call(this, t)))
                  ),
                ...
                Pe(Le(n), "slickPrev", function() {
                  return n.innerSlider.slickPrev();
                }),
                Pe(Le(n), "slickNext", function() {
                  return n.innerSlider.slickNext();
                }),
                Pe(Le(n), "slickGoTo", function(e) {
                  var t =
                    1 < arguments.length &&
                    void 0 !== arguments[1] &&
                    arguments[1];
                ...
                Pe(Le(n), "slickPause", function() {
                  return n.innerSlider.pause("paused");
                }),
                Pe(Le(n), "slickPlay", function() {
                    ...
                    if (this.props.responsive) {
                      ...
                      t.sort(function(e, t) {
                        ...
                        t.forEach(function(n, r) {
                          ...
                          (i =
                            0 === r
                              ? Oe()({ minWidth: 0, maxWidth: n })
                              : Oe()({ minWidth: t[r - 1] + 1, maxWidth: n })),
                            O() &&
                              e.media(i, function() {
                                e.setState({ breakpoint: n });
                              });
                        });
                      var n = Oe()({ minWidth: t.slice(-1)[0] });
                      O() &&
                ...
                },
                {
                  ...
                  value: function() {
                    this._responsiveMediaHandlers.forEach(function(e) {
                      Ce.unregister(e.query, e.handler);
                    });
                  }
                },
                {
                  ...
                  value: function() {
                    ...
                    (e = this.state.breakpoint
                      ? "unslick" ===
                        ...
                        ? "unslick"
                        : Ee({}, ke, {}, this.props, {}, t[0].settings)
                      : Ee({}, ke, {}, this.props)).centerMode &&
                    ...
                    for (
                      ...
                      var p = e.getElementRefHandler;
                      e.variableWidth
                        ? o.push(
                            i.a.createElement(
                              "div",
                              { key: a, style: { width: s }, ref: p && p(a) },
                              l
                            )
                          )
                        : o.push(
                    ...
                    if ("unslick" !== e)
                      return (
                        ...
                        i.a.createElement(
                          we,
                          _e({ ref: this.innerSliderRefHandler }, e),
                          o
                        )
                      );
